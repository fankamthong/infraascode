...
########################################
# This is for nginx web server setup
########################################

port = 8080

#Create a SecurityGroup that permits HTTP ingress and unrestricted egress.
sec_grp = aws.ec2.SecurityGroup('web-secgrp',
...
# Create a load balancer to listen for HTTP traffic on port 8080.
loadbalancer = aws.lb.LoadBalancer('web-lb',
	security_groups=[sec_grp.id],
	subnets=net.default_vpc_subnets.ids,
)

targetgroup = aws.lb.TargetGroup('web-tg',
	port=port,
	protocol='HTTP',
	target_type='ip',
	vpc_id=net.default_vpc.id,
...
image = docker.Image("nginx-web-dockerimage",
